class Platformer extends Phaser.Scene {
    ...
    create() {
        ...
        this.coinTxt = this.add.bitmapText(50, 65, 'Ariel', "coins: " + this.coinScore);
        ...
        //extra credit: 
        this.power = this.map.createFromObjects("Powerup", {
            name: "jumpHigh",
            key: "tilemap_sheet",
            frame: 67
        });
    ...
    powerup(){
        if(this.poweredUp == false){
            this.JUMP_VELOCITY = this.JUMP_VELOCITY * 2;
        }
        this.poweredUp = true;
    }
    ...
    update() {
        this.frame++;
        this.coinTxt.setText("Score: " + this.coinScore);
        this.coinTxt.x = my.sprite.player.x - 50
        if(this.frame % 50 == 0){
        ...
        if(this.frame % 150){
            this.coins.frame = 152;
        }
        if(this.frame % 72){
            this.coins.frame = 151;
        }
    }
}